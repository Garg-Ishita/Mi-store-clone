...
function App() {
  ...
  return (
    <Router>
      ...
      <HotAccessoriesMenu />
      <Routes>
      <Route exact path="/music" element={ <HotAccessories music={a.hotAccessories.music} musicCover={a.hotAccessoriesCover.music}  />}>
      
       </Route>

       <Route exact path="/smartDevice" element={<HotAccessories smartDevice={a.hotAccessories.smartDevice} smartDeviceCover={a.hotAccessoriesCover.smartDevice}  />
       }>
       </Route>
